...
export function SuggestedPromptChip({ label, onClick }: SuggestedPromptChipProps) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="group flex items-center gap-2 rounded-sm border border-white/5 bg-surface-elevated px-3 py-2.5 text-left text-[12px] text-ink-on-dark transition-colors hover:border-agent-thinking/30 hover:bg-agent-thinking/5 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-agent-thinking/40"
    >
      <Sparkles
